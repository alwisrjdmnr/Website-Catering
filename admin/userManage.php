                                ...
                                echo '<tr>
                                    ...
                                    <td class="text-center">
                                        <div class="row mx-auto" style="width:112px">
                                            ...
                                            if($Id == 1) {
                                                echo '<button class="btn btn-sm btn-danger" disabled style="margin-left:9px;">Hapus</button>';
                                            }
                                            else {
                                                echo '<form action="partials/_userManage.php" method="POST">
                                                        <button name="removeUser" class="btn btn-sm btn-danger" style="margin-left:9px;">Hapus</button>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header" style="background-color: rgb(111 202 203);">
        <h5 class="modal-title" id="newUser">Tambah User Baru</h5>
      ...
      <div class="modal-body">
        <form action="partials/_userManage.php" method="post">
              <div class="form-group">
                  ...
                  <input class="form-control" id="username" name="username" placeholder="Masukkan Username" type="text" required minlength="3" maxlength="11">
              </div>
              <div class="form-row">
              ...
              <div class="form-group row my-0">
                    <div class="form-group col-md-6 my-0">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="number" class="form-control" id="phone" name="phone" placeholder="Masukkan No Hp" required pattern="[0-9]{10}" maxlength="13">
                        </div>
                    </div>
                    <div class="form-group col-md-6 my-0">
              ...
              <div class="form-group">
                  <b><label for="password1">Ulangi Password:</label></b>
                ...
                <div class="form-group row my-0">
                    <div class="form-group col-md-6 my-0">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="number" class="form-control" id="phone" name="phone" value="<?php echo $phone; ?>" required pattern="[0-9]{10}" maxlength="13">
                        </div>
                    </div>
                    <div class="form-group col-md-6 my-0">
                        <b><label for="userType">Type:</label></b>
