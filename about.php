          ...
          <div class="carousel-item active">
            ...
            <div class="carousel-container">
              <div class="carousel-content">
                <h2 class="animate__animated animate__fadeInDown">Selamat Datang di <span>Catering Trio</span></h2>
  ...
  <main id="main">
    ...
    <section id="about" class="about">
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-6">
            <h3>Selamat Datang di <strong>Catering Trio</strong></h3>
            <h3><strong>Tempat Pemesanan Catering Terpecayay</strong></h3>
            <p class="font-italic">
          </div>
