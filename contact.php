                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-6">
                            <div class="form-group mt-3">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="number" class="form-control" id="phone" name="phone" aria-describedby="basic-addon" placeholder="Masukkan Nomer Anda" required pattern="[0-9]{10}" value="13"<?php echo $phone ?>">
                                </div>
                            </div>
                          </div>
                          <div class="col-lg-6">
                          ...
                          <div class="col-lg-6">
                            <div class="form-group mt-3">
                              ...
                              <input class="form-control" id="password" name="password" placeholder="Masukkan Password" type="password" placeholder="Enter Your Password" required data-toggle="password">
                            </div>
                          </div>
                          <div class="col-lg-12">
                            <div class="form-group  mt-3">
                                <textarea class="form-control" id="message" name="message" rows="2" required minlength="6" placeholder="Apa Ada Yang Bisa Kami Bantu ?"></textarea>
                            </div>
                          </div>
                          <?php if($loggedin){ ?>
                            <div class="col-lg-12">
                              <button type="submit" class="btn btn-danger-gradiant mt-3 mb-3 text-white border-0 py-2 px-3"><span> Kirim Sekarang<i class="ti-arrow-right"></i></span></button>
                              <button type="button" class="btn btn-danger-gradiant mt-3 mb-3 text-white border-0 py-2 px-3 mx-2" data-toggle="modal" data-target="#history"><span> Riwayat<i class="ti-arrow-right"></i></span></button>
                            </div>
                          <?php }else { ?>
                            <div class="col-lg-12">
                              <button type="submit" class="btn btn-danger-gradiant mt-3 text-white border-0 py-2 px-3" disabled><span> Kirim Sekarang <i class="ti-arrow-right"></i></span></button>
                              <small class="form-text text-muted">Silahkan Login Terlebih Dahulu</small>
                            </div>
                          <?php } ?>
                        </div>
                      </form>
                  ...
                  <?php
                    ...
                    echo '<div class="col-lg-4 bg-image" style="background-image:url(img/contact.jpg)">
                          <div class="detail-box p-4">
                            ...
                            <h5 class="text-white font-weight-light mb-3 mt-4">Kontak Kami</h5>
        ...
        <div class="modal-dialog modal-lg" role="document">
          <div class="modal-content">
            <div class="modal-header" style="background-color: rgb(187 188 189);">
              <h5 class="modal-title" id="adminReply">Kotak Masuk</h5>
            ...
            <div class="modal-body" id="messagebd">
              <table class="table-striped table-bordered col-md-12 text-center">
                ...
                <?php 
                    ...
                    if($count==0) {
                      ?><script> document.getElementById("messagebd").innerHTML = '<div class="my-1">Tidak Ada Pesan.</div>';</script> <?php
                    }
                ?>
                </tbody>
		          </table>
